...
var app = {
    ...
    loadShit : function() {
        ...
        function onAfterGetPatternData() {
        ...
        function onAfterLoadFile() {
            console.log('Getting pattern')
            cordova.exec(
                onAfterGetPatternData,
                null,
                'ModPlyr',
        ...
        function onAfterGetFiles(files) {
        ...
        function onAfterGetDirectories(paths) {
